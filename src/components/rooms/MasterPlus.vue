<template>
  <div
    id="room"
    class="tw-rounded-3xl tw-flex tw-flex-col tw-h-96 tw-w-96 collapsed"
    role="button"
  ...
  >
    <div class="image tw-bg-image tw-h-96 tw-w-full"></div>
    <div id="text-area">
      ...
      <div id="description3" class="collapse tw-bg-text tw-max-h-36">
        <p class="tw-font-roboto tw-text-lg tw-text-left">
          ...
          entre os demais serviços do executivo plus. Ideal para 2 à 3 pessoas.
          A melhor localização do hotel, com vista para o jardim.
        </p>
      </div>
    </div>
  </div>
